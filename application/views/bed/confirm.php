        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                <div class="page-next-level">
                    ...
                    <h4 class="title mt-4 mb-3">ทำการจองเตียงสนาม สำเร็จ </h4>
                    <div class="page-next">
                ...
                <div class="d-flex features feature-clean">
                    <div class="content ms-4">
                        ...
                        <p class="text-muted mb-0">
                            <?php echo $booking->filedbed_name;?>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                <div class="d-flex features feature-clean">
                    <div class="content ms-4">
                        ...
                        <p class="text-muted mb-0">
                            <?php echo $booking->patient_idcard;?>
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                <div class="d-flex features feature-clean">
                    <div class="content ms-4">
                        ...
                        <p class="text-muted mb-0">
                            <?php echo $booking->patient_phone;?>
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                <div class="d-flex features feature-clean">
                    <div class="content ms-4">
                        ...
                        <p class="text-muted mb-0">
                            <?php echo $booking->patient_line ? $booking->patient_line: '-';?>
                        </p>
                    </div>
                </div>
            </div>
